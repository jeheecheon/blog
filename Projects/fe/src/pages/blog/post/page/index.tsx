...
export const Post = ({ liked = false }: {
    ...
    return (
        <div className='flex flex-col items-center relative -top-[150px] z-10'>
            ...
            <div className='flex flex-row justify-center gap-2 items-center text-lg fill-sky-700'>
                <div onClick={handleLikeCliked} className='flex flex-row gap-1 justify-between items-center cursor-pointer
                border-2 py-[3px] px-2'>
                    {
                        isLiked ? (
                ...
                <div className='flex flex-row justify-center gap-1 cursor-pointer border-2 py-[3px] px-2'>

...
function ButtonInCommentBox({
    ...
    return (
        <button
            ...
            border-[0.09rem] py-[0.1875rem] px-2 text-xs gap-2 text-default-17-dark dark:text-default-15
            bg-default-1 dark:bg-default-3-dark border-default-6 dark:border-default-7-dark ${className}`}
            onClick={onClick}
        >
            {children}
        </button>

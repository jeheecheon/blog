...
const ArticleContent: React.FC<ArticleContentProps> = React.memo(({
    ...
    return (
        <div className={`blog-post flex flex-col items-center w-full ${className}`}>
            ...
            <div className='px-5 text-pretty max-w-[780px] h-fit min-h-[25vh] rounded-2xl shadow-md dark:shadow-lg dark:drop-shadow-lg
                    overflow-hidden pb-5 mb-10 whitespace-pre-line w-full flex flex-col items-center 
                    bg-white dark:bg-default-3-dark'>
                <div className='bg-default-18 dark:bg-default-18-dark h-[10px] w-[170px] rounded-2xl relative bottom-1' />
